...
_STAGGER    = 60                       # px ô phải lùi thêm so với ô trái cùng hàng
_ROW_GAP    = 150                      # px giữa 2 hàng (pole -> P3 -> P5)
_ROW_TOP    = 1636                     # px dưới vạch xuất phát (gate_y=1546 + 90)
_COL_L      = 423 - _ZIG_OFFSET
_COL_R      = 423 + _ZIG_OFFSET
_GRID_SLOTS=[
